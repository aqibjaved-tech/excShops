                    ...
                    <div class="row">
                                              ...
                                              <div class="product-item-img">
                                                ...
                                                <?php
                                                  ...
                                                  <!-- <a class="product-item-img-link" href=""> -->
                                                      <img src="<?php echo e($product['largeThumbnails'][0]); ?>" alt="Product Item" />
                                                  </a>
                                                  <!--Add to Link-->
                        ...
                        <div class="col-lg-3 col-12 order-lg-1 sidebar-container">
                            <aside class="widget-area">
                              ...
                              <?php echo $__env->make('template/frontend/themes/mazaar/modules/product-filter-size-widget', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('template/frontend/themes/mazaar/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\www\github\exc_app-develop\resources\views//template/frontend/themes/mazaar/pages/product-listing-left-sidebar.blade.php ENDPATH**/ ?>