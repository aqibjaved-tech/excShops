    ...
    <div class="site-wraper">
      ...
      <?php echo $__env->make('template/frontend/themes/mazaar/includes/header/header', ['data' => $data], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="page-contaiter">
            <?php echo $__env->make('template/frontend/themes/mazaar/modules/hero-banner-with-breadcrumb',['data' => $data,'bannerimg' => $bannerimg], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!--Product Content-->
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-12 align-self-center">
                            ...
                            <?php if(Session::has('success')): ?>
                              ...
                              Success! <strong>"<?php echo e($product['name']); ?>"</strong> has been added to your Cart! <a style="float: right;" href="<?php echo e(url('/cart')); ?>">View Cart</a>
                            </div>
                              <?php endif; ?>
                            ...
                            <div class="product-page-gallery">
                                <div class="product-gallery-media mfp-gallery-popup">
                                    <div class="product-media-slider">
                                      <?php ////print_r(88990);
                                        ...
                                        // //die();
                                       ?>
                                      <?php $__currentLoopData = $product['largeThumbnails']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_gallery_image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <div class="product-gallery-image mfp-gallery-popup-link" data-mfp-src="<?php echo e($product_gallery_image); ?>">
                                          <img src="<?php echo e($product_gallery_image); ?>" alt="mazaar">
                                      </div>
                                ...
                                <div class="product-gallery-media-thumb">
                                    <div class="product-media-thumb-slider">
                                      <?php $__currentLoopData = $product['thumbnails']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_thumbnails): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <a class="product-gallery-image">
                                          <img src="<?php echo e($product_thumbnails); ?>" alt="mazaar">
                                      </a>
                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="product-page-content">
                                ...
                                <!--Product Title-->
                                <h4 class="product-item-title"><?php echo e($product['brand']['name']); ?></h4>
                                <h3 class="product-item-title"><?php echo e($product['name']); ?></h3>
                                <!--Product Ratting-->
                                ...
                                <form class="product-variations-form" autocomplete="off">
                                    ...
                                    <input type="hidden" name="pname" value="<?php echo e($product['name']); ?>" />
                                    <input type="hidden" name="price" value="<?php echo e($product['retailPrice']); ?>" />
                                    <input type="hidden" name="cartid" id="cartid" value="<?php echo e(Session::get('cartid')); ?>" />
                                    ...
                                    <div class="product-variations-child">
                                        ...
                                        <div class="product-select-size">
                                          <?php $__currentLoopData = $product['variants']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variants): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                            <label for="size_<?php echo e($variants['size']); ?>">
                                                <input type="checkbox" id="size_<?php echo e($variants['size']); ?>" name="size" value="xs" />
                                                <?php echo e($variants['size']); ?>

                                                <input type="hidden"  id="size_<?php echo e($variants['quantityAvailable']); ?>" name="variaint_quantity" value="xs" />
                                            </label>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                          </div>
                                ...
                                <div class="product-add-to-button">
                                    <a class="product-add-to-whishlist" id="<?php echo e($product['id']); ?>" href=""><i class="ti-heart left"></i>Add to Wishlist</a>
                                    <a class="product-add-to-whishlist" href="#"><i class="ti-reload left"></i>Add to Compare</a>
                                </div>

                                <!--Product Meta-->
                                <div class="product-meta">
                                    <span>Sku:<span><?php echo e($product['itemNumber']); ?></span>
                                    </span>
                                    <span>Categories:
        ...
        jQuery(".single_add_to_cart_button").click(function(e){
          ...
          if(!cartid){
            ...
            jQuery.ajax({
              ...
              success:function(data){
                ...
                jQuery.ajax({
                  ...
                  data:{_token:"<?php echo csrf_token(); ?>",cartid:data,item:finaldata},
                  success:function(data){
                  location.reload();
                  }
                });
            ...
            jQuery.ajax({
              type:'POST',
              url:'<?php  echo $actual_link; ?>',
              data:{_token:"<?php echo csrf_token(); ?>",cartid:cartid,item:finaldata},
              success:function(data){
                location.reload();
...
<?php echo $__env->make('template/frontend/themes/mazaar/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ahmajucr/public_html/resources/views/template/frontend/themes/mazaar/pages/product-details.blade.php ENDPATH**/ ?>