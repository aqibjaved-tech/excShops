            ...
            <div class="row">
                ...
                <div class="site-logo">
                    <a href="<?php echo e(url('/')); ?>">
                        <img src="<?php echo e(asset('public/img/exchangecollective-logo.png')); ?>" class="logo-dark" alt="Mazaar" />
                        <img src="<?php echo e(asset('public/img/exchangecollective-logo-dark.png')); ?>" class="logo-light" alt="Mazaar" />
                    </a>
                </div>
                <!--End Logo-->
                ...
                <div class="searchbar-menu">
                    <div class="searchbar-menu-inner">
                        ...
                        <div class="search-form-wrap">
                            <form action="<?php echo e(url('product-filter')); ?>" method="get">
...
<!-- End Header -->
<?php /**PATH /home/ahmajucr/public_html/resources/views/template/frontend/themes/mazaar/includes/header/header.blade.php ENDPATH**/ ?>