                                                ...
                                                <form action="<?php echo url('product-filter')?>" method="get">
                                                    <div class="form-field-wrapper">
                                                        ...
                                                        <select name="filter_categries" class="form-full">
                                                            ...
                                                            <?php $__currentLoopData = $products['filters']['categories']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div class="form-field-wrapper">
                                                        ...
                                                        <select name="filter_gender" class="form-full">
                                                            ...
                                                            <?php $__currentLoopData = $products['filters']['genders']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gender => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($value); ?>"><?php echo e($value); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </div>
                                                    <div class="form-field-wrapper">
                                                        ...
                                                        <select name="filter_brand" class="form-full">
                                                            ...
                                                            <?php $__currentLoopData = $products['filters']['brands']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($value); ?>"><?php echo e($value); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    ...
                                                    <div class="form-field-wrapper">
                                                        ...
                                                        <select name="filter_color" class="form-full">
                                                            ...
                                                            <?php $__currentLoopData = $products['filters']['colors']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($value); ?>"><?php echo e($value); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>>
                                                        </select>
                                                    </div>
                                                    <div class="form-field-wrapper">
                                                        ...
                                                        <select name="filter_size" class="form-full">
                                                            ...
                                                            <?php $__currentLoopData = $products['filters']['sizes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($value); ?>"><?php echo e($value); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="product-item-element col-sm-6 col-md-6 col-lg-4">
                                        <div class="product-item">
                                            ...
                                            <div class="product-item-img">
                                                ...
                                                <a class="product-item-img-link" href="<?php echo e(url('product/'.$product['id'])); ?>">
                                                    ...
                                                    <div class="add-to-link">
                                                        <a class="btn btn--primary btn--sm" href="<?php echo e(url('product/'.$product['id'])); ?>">
                                                                View Details</a>
                                                    </div>
                                                    <!--Hover Icons-->
                                            ...
                                            <div class="product-item-content">
                                                ...
                                                <a href="<?php echo e(url('product/'.$product['id'])); ?>" class="product-item-title"><span><?php echo e($product['name']); ?></span></a>
...
<?php echo $__env->make('template/frontend/themes/mazaar/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ahmajucr/public_html/resources/views/template/frontend/themes/mazaar/pages/filter_product.blade.php ENDPATH**/ ?>