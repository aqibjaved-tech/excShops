              ...
              <div class="container">
                  ...
                  <?php if(Session::has('msg')): ?>
                    <div class="alert alert-success alert-dismissible" role="alert" >
                      ...
                      Success! <strong>"<?php echo e(Session::get('msg')); ?>"</strong>
                    </div>
                  <?php endif; ?>
                  <!--Alert-->

                  <form role="form" action="<?php echo e(route('stripe.post')); ?>" method="post"  class="row product-checkout require-validation"
                      ...
                      <div class="col-md-6 pr-md-5">
                          <div class="product-checkout-customer_details billing_details">
                              ...
                              <div class="row billing-fields__field-wrapper">
                                  <p class="form-field-wrapper col-sm-6">
                                      ...
                                      <input class="form-full input--lg" name="billing_first_name" id="billing_first_name" title="First Name" value="<?php echo e(old('billing_first_name')); ?>" placeholder="First Name" required="" aria-required="true" type="text" />
                                  </p>
                                  <p class="form-field-wrapper col-sm-6">
                                      <label for="billing_last_name" class="">Last Name&nbsp;<abbr class="required" title="required">*</abbr></label>
                                      <input class="form-full input--lg" name="billing_last_name" id="billing_last_name" placeholder="" value="<?php echo e(old('billing_last_name')); ?>" type="text" />
                                  </p>
                                  <p class="form-field-wrapper col-sm-12">
                                      <label for="billing_company" class="">Company Name &nbsp;<span class="optional">(optional)</span></label>
                                      <input class="form-full input--lg" name="billing_company" id="billing_company" placeholder="" value="<?php echo e(old('billing_company')); ?>" type="text" />
                                  </p>
                                  <p class="form-field-wrapper col-sm-12">
                                  ...
                                  <p class="form-field-wrapper col-sm-12">
                                      ...
                                      <input class="form-full input--lg" name="billing_address_1" id="billing_address_1" placeholder="House number and street name" value="<?php echo e(old('billing_address_1')); ?>" type="text" />
                                  </p>
                                  <p class="form-field-wrapper col-sm-12">
                                      <input class="form-full input--lg" name="billing_address_2" id="billing_address_2" placeholder="Apartment, suite, unit etc. (optional)" value="<?php echo e(old('billing_address_2')); ?>" type="text" />
                                  </p>
                                  <p class="form-field-wrapper col-sm-12">
                                      <label for="billing_city">Town / City&nbsp;<abbr class="required" title="required">*</abbr></label>
                                      <input class="form-full input--lg" name="billing_city" id="billing_city" title="" value="<?php echo e(old('billing_city')); ?>" placeholder="" required="" aria-required="true" type="text" />
                                  </p>
                                  <p class="form-field-wrapper col-sm-12">
                                  ...
                                  <p class="form-field-wrapper col-sm-12">
                                      ...
                                      <input class="form-full input--lg" name="billing_postcode" id="billing_postcode" title="" value="<?php echo e(old('billing_postcode')); ?>" placeholder="" required="" aria-required="true" type="text" />
                                  </p>
                                  <p class="form-field-wrapper col-sm-12">
                                      <label for="billing_phone">Phone &nbsp;<abbr class="required" title="required">*</abbr></label>
                                      <input class="form-full input--lg" name="billing_phone" id="billing_phone" title="" value="<?php echo e(old('billing_phone')); ?>" required="" aria-required="true" type="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="123-4567-8901"/>
                                  </p>
                                  <p class="form-field-wrapper col-sm-12">
                                      <label for="billing_email">Email Address  &nbsp;<abbr class="required" title="required">*</abbr></label>
                                      <input class="form-full input--lg" name="billing_email" id="billing_email" title="" value="<?php echo e(old('billing_email')); ?>" placeholder="" required="" aria-required="true" type="email" />
                                  </p>
                                  <p class="form-field-wrapper col-sm-12">
                          ...
                          <div class="product-checkout-customer_details shipping_details">
                              ...
                              <div class="row billing-fields__field-wrapper">
                                  <p class="form-field-wrapper col-sm-6">
                                      <label for="billing_first_name">First Name&nbsp;<abbr class="required" title="required">*</abbr></label>
                                      <input class="form-full input--lg" name="shipping_first_name" id="shipping_first_name" title="First Name" value="<?php echo e(old('shipping_first_name')); ?>" placeholder="First Name"  type="text" />
                                  </p>
                                  <p class="form-field-wrapper col-sm-6">
                                      <label for="billing_last_name" class="">Last Name&nbsp;<abbr class="required" title="required">*</abbr></label>
                                      <input class="form-full input--lg" name="shipping_last_name" id="shipping_last_name" placeholder="" value="<?php echo e(old('shipping_last_name')); ?>" type="text" />
                                  </p>
                                  <p class="form-field-wrapper col-sm-12">
                                      <label for="billing_company" class="">Company Name &nbsp;<span class="optional">(optional)</span></label>
                                      <input class="form-full input--lg" name="shipping_company" id="shipping_company" placeholder="" value="<?php echo e(old('shipping_company')); ?>" type="text" />
                                  </p>
                                  <p class="form-field-wrapper col-sm-12">
                                      <label for="billing_country" class="">Country &nbsp;<abbr class="required" title="required">*</abbr></label>
                                  ...
                                  <p class="form-field-wrapper col-sm-12">
                                      <label for="billing_address_1" class="">Street Address &nbsp;<abbr class="required" title="required">*</abbr></label>
                                      <input class="form-full input--lg" name="shipping_address_1" id="shipping_address_1" placeholder="House number and street name" value="<?php echo e(old('shipping_address_1')); ?>" type="text" />
                                  </p>
                                  <p class="form-field-wrapper col-sm-12">
                                      <input class="form-full input--lg" name="shipping_address_2" id="shipping_address_2" placeholder="Apartment, suite, unit etc. (optional)" value="<?php echo e(old('shipping_address_2')); ?>" type="text" />
                                  </p>
                                  <p class="form-field-wrapper col-sm-12">
                                      <label for="shipping_city">Town / City&nbsp;<abbr class="required" title="required">*</abbr></label>
                                      <input class="form-full input--lg" name="shipping_city" id="shipping_city" title="" value="<?php echo e(old('shipping_city')); ?>" placeholder=""  type="text" />
                                  </p>
                                  <p class="form-field-wrapper col-sm-12">
                                  ...
                                  <p class="form-field-wrapper col-sm-12">
                                      <label for="billing_postcode">Zip&nbsp;<abbr class="required" title="required">*</abbr></label>
                                      <input class="form-full input--lg" name="shipping_postcode" id="shipping_postcode" title="" value="<?php echo e(old('shipping_postcode')); ?>" placeholder=""  type="text" />
                                  </p>
                                  <p class="form-field-wrapper col-sm-12">
                                      <label for="billing_phone">Phone &nbsp;<abbr class="required" title="required">*</abbr></label>
                                      <input class="form-full input--lg" name="shipping_phone" id="shipping_phone" title="" value="<?php echo e(old('shipping_phone')); ?>" type="text"  type="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="123-4567-8901"/>
                                  </p>
                                  <p class="form-field-wrapper col-sm-12">
                                      <label for="billing_email">Email Address  &nbsp;<abbr class="required" title="required">*</abbr></label>
                                      <input class="form-full input--lg" name="shipping_email" id="shipping_email" title="" value="<?php echo e(old('shipping_email')); ?>" placeholder=""  type="email" />
                                  </p>
...
<?php echo $__env->make('template/frontend/themes/mazaar/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ahmajucr/public_html/resources/views/template/frontend/themes/mazaar/pages/checkout.blade.php ENDPATH**/ ?>