...
// echo count($final_data).'---';
                            ...
                            <article>
                                <form class="cart-form" method="post" action="<?php echo e(url('cart')); ?>">
                                  <?php echo csrf_field(); ?>
                                             ...
                                             foreach ($final_data['id'] as $key=>$final_value)
                                             {
                                                   ...
                                                   <tr>
                                                    <td class="product-remove">
                                                        ...
                                                        <a href="<?php echo e(url('/removeproduct/'.$final_value)); ?>">
      ...
      //  localStorage.setItem('cartid', cartid);
        ...
        jQuery(".checkout-button").click(function(e){
            ...
            $('input[name=shipping_email]').filter(function(){
                if ($.trim(this.value).length == 0){
                  ...
                  jQuery.ajax({
                    type:'post',
                    url:'<?php echo e(url('checkoutdata')); ?>',
                    data:{_token:"<?php echo csrf_token(); ?>",shipping_email:shipping_email,cartid:cartid},
        ...
        jQuery("i.fa.fa-times-circle.delete").click(function(e){
          ...
          jQuery.ajax({
            type:'POST',
            url:'<?php echo e(url('/removeproduct')); ?>',
            data:{_token:"<?php echo csrf_token(); ?>" ,rowid:rowid,cart_id:cart_id},
            success:function(data){
              location.reload();
            //  alert(data.success);
              // setTimeout(function(){
        ...
        //  return false;
          ...
          //   type:'POST',
          //   url:'/updatecart',
          //   data:{_token:"<?php echo csrf_token(); ?>" ,product_id:product_id,product_qty:product_qty},
          //   success:function(data){
          //     ///alert(data.success);
          //     location.reload();
          //     jQuery(".alert-success").fadeTo(2000, 1500).slideUp(500, function(){
...
<?php echo $__env->make('template/frontend/themes/mazaar/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ahmajucr/public_html/resources/views/template/frontend/themes/mazaar/pages/cart.blade.php ENDPATH**/ ?>