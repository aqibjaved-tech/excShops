    ...
    <nav id="navigation" class="header-nav">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="site-logo">
                    <a href="home.html">
                        <img src="<?php echo e(asset('img/exchangecollective-logo.png')); ?>" class="logo-dark" alt="Mazaar" />
                        <img src="<?php echo e(asset('img/exchangecollective-logo-dark.png')); ?>" class="logo-light" alt="Mazaar" />
                    </a>
                </div>
                <!--End Logo-->
                    ...
                    <ul>
                      <?php $__currentLoopData = $data['categories']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <li class="nav-menu-item mega-menu">
                              <a href="product_listing.html"><?php echo e($category['name']); ?></a>
                                            ...
                                            <?php $counter = 1;?>
                                                ...
                                                <?php if($counter%5 == 0){ ?>
                                                  ...
                                                  <div class="col-lg-3">
                                                    <ul>
                                                <?php } ?>
                                                  <li><a href="<?php echo e(url(strtolower($associatedCategory))); ?>"><span class="dropdown-title cout-<?php echo e($counter); ?>"><?php echo e($associatedCategory); ?></span></a></li>
                                                  <?php $counter++; ?>
...
<!-- End Header -->
<?php /**PATH C:\xampp\htdocs\www\github\exc_app-develop\resources\views/template/frontend/themes/mazaar/includes/header/header.blade.php ENDPATH**/ ?>